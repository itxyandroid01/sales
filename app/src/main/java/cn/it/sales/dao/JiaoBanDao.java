...
public class JiaoBanDao {
    ...
    //生成接班记录到本地数据库
    public MyResult InsertDataToDB(JieBanInfo jieBanInfo) {
        List<String> list1 = new ArrayList<String>();
        int banci = jieBanInfo.getBanCi();
        int gonghao = jieBanInfo.getGongHao();
        String xingming = jieBanInfo.getXingMing();
        int jiebangonghao = jieBanInfo.getJieBanGongHao();
        String jiebanshijian = jieBanInfo.getJieBanShiJian();
        int jiaoBanKuCunLiang = jieBanInfo.getJiaoBanKuCunLiang();
        String jiebanshiyi=jieBanInfo.getJieBanShiYi();
        ...
        String sql2 = String.format("insert into t_jiaoban_shangpin(" +
                ...
                "values(%d,%d,'%s',%d)", banci, jiebangonghao, jiaoBanKuCunLiang);
        list1.add(sql2);
        String sql3 = String.format("insert into  t_jiaoban_shiyi (banci,gonghao,jiebanshiyi) values(banci,gonghao"+jiebanshiyi+")");
        list1.add(sql3);
